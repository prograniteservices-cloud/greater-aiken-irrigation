...
After completing any task or set of tasks, the agent MUST stop execution and await user confirmation before proceeding to the next task. This ensures user oversight and prevents autonomous progression.
